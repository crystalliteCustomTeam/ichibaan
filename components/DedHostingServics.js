                    ...
                    <Row className={styles.dedhostingRow}>
                        <Col md={10}>
                            <div className={styles.dedhostingBody}>
                                ...
                                <p>
                                    Dedicated server hosting covers complete infrastructure management. Ichibaan Logic  takes full responsibility for the
                    ...
                    <Row>
                        <Col md={12}>
                            <div className={styles.dedlist}>
                                ...
                                <p>
                                    If you require a secure and high-performance solution, then Ichibaan Logic  dedicated servers<br />
