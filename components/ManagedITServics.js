                    ...
                    <Row className={styles.manageITServiceRow}>
                        <Col xl={12}>
                            <div className={styles.manageITServ}>
                                ...
                                <p>
                                    Globally, IT outsourcing is a well-proven and highly successful “managed services” business model. Ichibaan Logic  can help you infuse<br />
                        ...
                        <Col xl={12}>
                            <div className={styles.manageServc}>
                                <h5>WHAT Ichibaan Logic  OFFERS</h5>
                            </div>
