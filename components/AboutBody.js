                    ...
                    <Row>
                        <Col xl={12}>
                            <div>
                                ...
                                <p>The key to Ichibaan Logic 's prosperity has been its B2B focus and its formative and enduring vision to be the leading system quantifying instrument and resolution supplier within the region.</p>
                            </div>
                        </Col>
                    </Row>
                </Container>
