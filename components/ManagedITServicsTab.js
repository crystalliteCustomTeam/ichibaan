                            ...
                            <MDBTabsContent>
                                <MDBTabsPane show={basicActive === 'tab1'}>
                                    <div className={styles.tabPanContent}>
                                        ...
                                        <p>
                                            Ichibaan Logic  is ready to tailor your business needs by adding the value to the rapid change and advancement in your business. We support our clients in developing a new solution based on their unique business requirements.
                                        </p>
                                    </div>
                                </MDBTabsPane>
                                ...
                                <MDBTabsPane show={basicActive === 'tab4'}>
                                    <div className={styles.tabPanContent}>
                                        ...
                                        <p>
                                            Ichibaan Logic  has trained and exceedingly competent staff that can serve you with the best of their capacity. Our employees face and meet the challenge to resolve your problems in no time.
                                        </p>
                                    </div>
                                </MDBTabsPane>
                            </MDBTabsContent>
