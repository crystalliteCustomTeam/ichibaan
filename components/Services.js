...
import voice from '../public/images/icons/voice.png'
import messageing from '../public/images/icons/messageing.png'
//
                                    ...
                                    <MDBTabsLink onClick={() => handleBasicClick('tab8')} active={basicActive === 'tab8'}>
                                        <div className={styles.tabsPan}>
                                            <Image className='img-fluid'
                                                ...
                                                alt="Transcription"
                                            />
                                            <h5>Voice Services</h5>
                                            <p>Professional voice services for seamless IVR, call forwarding, and voicemail solutions.</p>
                                        </div>
                                    </MDBTabsLink>
                                </MDBTabsItem>
                                ...
                                <MDBTabsItem>
                                    <MDBTabsLink onClick={() => handleBasicClick('tab9')} active={basicActive === 'tab9'}>
                                        <div className={styles.tabsPan}>
                                            ...
                                            />
                                            <h5>Messaging</h5>
                                            <p>Professional messaging services for seamless SMS, WhatsApp, and chatbot solutions.</p>
                                        </div>
                                    </MDBTabsLink>
                                </MDBTabsItem>
                            </MDBTabs>
                            ...
                            <MDBTabsContent>
                                <MDBTabsPane show={selectedService === 'tab1'}>
                                    <div className={styles.tabPanContent}>
                                        ...
                                        <p>Ichibaan Logic ’s expertise lies in building, publishing, and marketing engaging content that will grow your client base, increase customer retention and achieve your ultimate goal of sales. We formulate strategies in such a way that they make your social presence consistent and interesting.</p>
                                    </div>
                                ...
                                <MDBTabsPane show={selectedService === 'tab3'}>
                                    <div className={styles.tabPanContent}>
                                        ...
                                        <p>Globally, IT outsourcing is a well-proven and highly successful “managed services” business model. Ichibaan Logic  can help you infuse efficiency in your IT operations by providing End-to-End managed services.</p>
                                    </div>
                                    <div className={styles.tabSrvImg}>
                                        <div>
                                            <Image className='img-fluid'
                                ...
                                <MDBTabsPane show={selectedService === 'tab4'}>
                                    <div className={styles.tabPanContent}>
                                        ...
                                        <p>Dedicated server hosting covers complete infrastructure management. Ichibaan Logic  takes full responsibility for the monitoring, maintenance, security, and operation of your managed solution.</p>
                                    </div>
                                    <div className={styles.tabSrvImg}>
                                        <div>
                                            <Image className='img-fluid'
                                ...
                                <MDBTabsPane show={selectedService === 'tab6'}>
                                    <div className={styles.tabPanContent}>
                                        ...
                                        <p>Ichibaan Logic  will look out of your operations and documentation workloads, so you’ll focus a lot of on generating a lot of business and growth. We have a tendency to provide you with the liberty of macro managing your business. We’ve in-house time unit Specialists, Accountants and Document Coordinators.</p>
                                    </div>
                                    <div className={styles.tabSrvImg}>
                                        <div>
                                            <Image className='img-fluid'
