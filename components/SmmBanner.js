                    ...
                    <Row className={styles.digiRow}>
                        <Col md={6}>
                            <div className={styles.digiBanner}>
                                ...
                                <p>Ichibaan Logic  Social Media Marketing means more traffic, more calls and more sales! We offer data-driven strategies and surprising bottom-line results to fuel your business growth. Our SMM experts pen such stories that best narrate your BRAND.</p>
                                <div className={`smmBtn mt-4`}>
                                    <Link className='primary-btn mt-0' href="/career">
                                        Join Us
                                    </Link>
                                    <Link className='download' href="#" onClick={opnen}>
                                        <Image src={download} className='img-fluid' alt='Ichibaan Logic ' />
                                    </Link>
                                </div>
                            </div>
                        </Col>
