                            ...
                            <MDBTabsContent>
                                <MDBTabsPane show={basicActive === 'tab1'}>
                                    <div className={styles.tabPanContent}>
                                        ...
                                        <h3>Healthcare</h3>
                                        <p>
                                            Connect with the endless possibilities that help you grow in the Healthcare industry as now you get to innovate with the help of Ichibaan Logic ’s modern Healthcare Analytics. It empowers your establishment to quickly analyze available data and generate insights in real-time.
                                        </p>
                                    </div>
                                </MDBTabsPane>
                                <MDBTabsPane show={basicActive === 'tab2'}>
                                    <div className={styles.tabPanContent}>
                                        ...
                                        <p>
                                            Combat inconsistencies in with Ichibaan Logic ’s state-of-the-art Financial Analytics. Drive accurate break-downs with insights in real-time of any data leaks or financial dissipation. This enables you to make informed decisions when it comes to deriving profitable outcomes.
                                        </p>
                                    </div>
                                </MDBTabsPane>
                                <MDBTabsPane show={basicActive === 'tab3'}>
                                    <div className={styles.tabPanContent}>
                                        ...
                                        <h3>Retail</h3>
                                        <p>
                                            Transform the retail experience of your venture and your customers with Ichibaan Logic ’s Retail Analytics. You retail operations are now faster, smarter, and more streamlined to yield customer-centric outcomes. This not only allows you to improve profitability but also maximize efficiency while empowering your customers.
                                        </p>
                                    </div>
                                </MDBTabsPane>
                                <MDBTabsPane show={basicActive === 'tab4'}>
                                    <div className={styles.tabPanContent}>
                                        ...
                                        <h3>Manufacturing</h3>
                                        <p>
                                            We at Ichibaan Logic  recognize that every second in the manufacturing industry is crucial as any bottlenecks or latency issues can set you back for a massive financial hit. This is where Ichibaan Logic  comes in to transform the way that your business performs to serve the modern customers’ needs of today.
                                        </p>
                                    </div>
                                </MDBTabsPane>
                                <MDBTabsPane show={basicActive === 'tab5'}>
                                    <div className={styles.tabPanContent}>
                                        ...
                                        <h3>High Tech</h3>
                                        <p>
                                            The world of tech has shifting dynamics that feature instant innovation and is fueled by the ability to respond quickly to changes. This is where Ichibaan Logic ’s High-Tech Analytics come in to keep up with the modern trends of today and empower your business to harvest data from many sources and make lightning fast decision in no time.
                                        </p>
                                    </div>
                                </MDBTabsPane>
                                <MDBTabsPane show={basicActive === 'tab6'}>
                                    <div className={styles.tabPanContent}>
                                        ...
                                        <h3>Public Sector</h3>
                                        <p>
                                            Ichibaan Logic ’s Public Sector analytics combine your data to explore the insights on your industry and the deliverables of public sector that need to be highlighted. Our goal is to help the public sector outshine the rest.
                                        </p>
                                    </div>
                                </MDBTabsPane>
                            </MDBTabsContent>
